(function ($) {
    ...
    var ajaxurl = cutie_pie_admin.ajax_url;
    var CutiePieNonce = cutie_pie_admin.ajax_nonce;
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: cutie_pie_admin.upload_image,
            button: {
            text: cutie_pie_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'cutie_pie_notice_dismiss',
            '_wpnonce': CutiePieNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-cutie-pie-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-cutie-pie-notice').addClass('twp-installing');

        var data = {
            'action': 'cutie_pie_install_plugins',
            '_wpnonce': CutiePieNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = cutie_pie_admin.active
            var deactivate = cutie_pie_admin.deactivate
