...
jQuery(document).ready(function($){
    ...
    // Color Scheme
    $( '#customize-control-cutie_pie_color_schema .color-scheme-picker input' ).on( 'change', function() {
        ...
        if ( $( this ).is( ':checked' ) ) {
            ...
            var data = {
                'action': 'cutie_pie_color_schema_color',
    ...
    // Tygoraphy
	$('#_customize-input-cutie_pie_heading_font').change(function(){

		var currentfont = this.value;

		var data = {
            'action': 'cutie_pie_customizer_font_weight',
            'currentfont': currentfont,
            '_wpnonce': cutie_pie_customizer.ajax_nonce,
        };
        ...
        $.post( ajaxurl, data, function(response) {
            ...
            if( response ){
                ...
                $('#_customize-input-cutie_pie_heading_weight').empty();
                $('#_customize-input-cutie_pie_heading_weight').html(response);
