...
if ( !function_exists('cutie_pie_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function cutie_pie_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('Cutie_Pie_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'cutie_pie_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('Cutie_Pie_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class Cutie_Pie_Tab_Posts_Widget extends Cutie_Pie_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'cutie_pie_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'cutie-pie'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'cutie-pie'),
                    'type'           => 'heading',
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'cutie-pie'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'select_image_size' => array(
                    'label' => esc_html__('Select Image Size Featured Post:', 'cutie-pie'),
                    'type' => 'select',
                    'default' => 'medium',
                    'options' => array(
                        'thumbnail' => esc_html__('Thumbnail', 'cutie-pie'),
                        'medium' => esc_html__( 'Medium', 'cutie-pie' ),
                        'large' => esc_html__( 'Large', 'cutie-pie' ),
                        'full' => esc_html__( 'Full', 'cutie-pie' ),
                        ),
                    
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'cutie-pie'),
                    'description'   => esc_html__('Number of words', 'cutie-pie'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'cutie-pie'),
                    'type'          => 'heading',
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'cutie-pie'),
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'cutie-pie'),
                    'type'            => 'heading',
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'cutie-pie'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
                ...
                'tagged_heading' => array(
                    'label'           => esc_html__('Tagged', 'cutie-pie'),
                    'type'            => 'heading',
                ),
            );

            parent::__construct( 'cutie-pie-tabbed', esc_html__( 'CP: Tab Posts Widget', 'cutie-pie' ), $opts, array(), $fields );
                ...
                <div class="tab-head">
                     <ul class="twp-nav-tabs clear">
                        ...
                        <li tab-data="tab-popular" class="tab tab-popular active">
                            <a href="javascript:void(0)">
                                <span class="fire-icon tab-icon">
                                    <?php cutie_pie_the_theme_svg('popular'); ?>
                                </span>
                            </a>
                        </li>
                        ...
                        <li tab-data="tab-recent" class="tab tab-recent">
                            <a href="javascript:void(0)">
                                <span class="flash-icon tab-icon">
                                    <?php cutie_pie_the_theme_svg('flash'); ?>
                                </span>
                            </a>
                        </li>
                        ...
                        <li tab-data="tab-comments" class="tab tab-comments">
                            <a href="javascript:void(0)">
                                <span class="comment-icon tab-icon">
                                    <?php cutie_pie_the_theme_svg('comment-2'); ?>
                                </span>
                            </a>
                        </li>
                        <li tab-data="tab-tagged" class="tab tab-tagged">
                            <a href="javascript:void(0)">
                                <span class="comment-icon tab-icon">
                                    <?php cutie_pie_the_theme_svg('tagged'); ?>
                                </span>
                            </a>
                        </li>
