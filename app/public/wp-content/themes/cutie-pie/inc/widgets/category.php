 ...
 * @package CutiePie
 */
if ( !function_exists('cutie_pie_category_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function cutie_pie_category_widgets(){
        // Recent Post widget.
        register_widget('Cutie_Pie_Sidebar_Category_Widget');
    }
endif;
add_action('widgets_init', 'cutie_pie_category_widgets');
// Recent Post widget
if ( !class_exists('Cutie_Pie_Sidebar_Category_Widget') ) :
    /**
     * Recent Post.
     *
     * @since 1.0.0
     */
    class Cutie_Pie_Sidebar_Category_Widget extends Cutie_Pie_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'cutie_pie_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'cutie-pie'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'cutie-pie'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'cutie-pie'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_label' => array(
                    'label'         => esc_html__('Latest Label', 'cutie-pie'),
                    'type'          => 'text',
                    'default'          => esc_html__('Latest:', 'cutie-pie'),
                ),
            );
            parent::__construct('cutie-pie-category-layout', esc_html__('CP: Category Widget', 'cutie-pie'), $opts, array(), $fields);
        }
        /**
